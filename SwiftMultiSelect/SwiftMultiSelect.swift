...
public class SwiftMultiSelect {
    ...
    private class func getContacts() {
        ...
        ContactsLibrary.getContacts { _, data in
...
public struct Config {
    ...
    public struct tableStyle {
        ...
        public static var avatarMargin: Double = 12.0
...
public struct SwiftMultiSelectItem: Equatable {
    ...
    public init(id: String, title: String, description: String? = nil, image: UIImage? = nil, imageURL: String? = nil, color: UIColor? = nil, userInfo: Any? = nil) {
        self.id = id
        self.title = title
